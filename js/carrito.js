    ...
    if (productosEnCarrito && productosEnCarrito.length > 0){
        ...
        productosEnCarrito.forEach(producto => {
            ...
            div.innerHTML = `
                ...
                <img class="carrito-producto-imagen producto-info-container" src="${producto.imagen}" alt="${producto.titulo}">
                <div class="carrito-producto-info producto-info-container">
...
botonSiguiente.addEventListener("click", ()=>{
    ...
    if (nombre === "" || apellido === "" || celular === "" || email === "") {
        ...
        if (esValido == false) {
            const alertaFormulario = document.querySelector("#alerta-formulario2");
            alertaFormulario.classList.remove("disabled");

            setTimeout(() => {
                alertaFormulario2.classList.add("disabled");   
            }, 3000);
        } else {
